...
public class TracksRecyclerAdapter<T> extends RecyclerView.Adapter<TracksRecyclerAdapter<T>.GenericViewHolder> {
    ...
    private com.example.alisonjc.compplayertwo.spotify.model.UserTracks.Item mTracksItem;
    ...
    public void onBindViewHolder(final GenericViewHolder holder, final int position) {
        ...
        } else if (item instanceof com.example.alisonjc.compplayertwo.spotify.model.UserTracks.Item){
            mTracksItem = (com.example.alisonjc.compplayertwo.spotify.model.UserTracks.Item) item;
